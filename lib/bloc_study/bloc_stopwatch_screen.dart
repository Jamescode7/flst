...
class BlocStopWatchScreen extends StatefulWidget {
  const BlocStopWatchScreen({Key? key}) : super(key: key);

  @override
  State<BlocStopWatchScreen> createState() => _BlocStopWatchScreenState();
}

class _BlocStopWatchScreenState extends State<BlocStopWatchScreen> {
